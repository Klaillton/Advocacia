...
maeNome varchar(255) not null, 
nome varchar(255) not null, 
paiNome varchar(255), 
profissao varchar(255), 
rendaMensal decimal(19,2), 
rg varchar(255), 
...
primary key (codigo)) ENGINE=InnoDB DEFAULT CHARSET=utf8;
 ...
 alter table cidade add constraint  foreign key (codigo_estado) references estado (codigo);

 alter table cliente add constraint  foreign key (codigo_cidade) references cidade (codigo);
